...
print(ansi_color('magenda',"Python Project"))
print(ansi_color('italic',"Python Project"))
print(ansi_color('black',"Python Project"))
print(ansi_color('b_green',"Python Project"))
print(ansi_color('b_red',"Python Project"))
print(ansi_color('b_white',"Python Project"))